...
5. Once handshaking is done to negotiate the ciphers and the secure key, secure communication can happen.
     5 a. Wrap the data using SSLEngine before sending it through socketChannel
     5 b. On receiving response, unwrap the data using SSLEngine before processing the response.
6. Shutdown the engine once done with communication.
Workflow
